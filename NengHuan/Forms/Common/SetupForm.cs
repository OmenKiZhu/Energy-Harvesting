...
namespace NengHuan.Forms.Common
{
    ...
    {
        //数据库连接字符串
        public static String conStr = "user id=nyhj;password=nyhj!@345;database=yethannyhj;server=127.0.0.1;port=3306;charset=utf8"; 
        //public static String conStr = "user id=nyhj;password=nyhj!@345;database=yethannyhj;server=121.43.123.32;port=3306;charset=utf8";
        /// <summary>
        /// 获取一个日志记录器
        /// </summary>
